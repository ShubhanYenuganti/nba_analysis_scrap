...
for elem in arr:
    ...
    for row in rows:
        ...
        cols = [ele.text.strip() for ele in cols][13]
        data_shooting_percentage.append(cols) # Get rid of empty values

def getStats():
    return data_shooting_percentage
